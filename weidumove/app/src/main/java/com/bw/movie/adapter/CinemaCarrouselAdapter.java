 ...
 *Description:旋转木马影院
 */
public class CinemaCarrouselAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private Context context;
    private List<CinemaMoidById.ResultBean> list;

    public CinemaCarrouselAdapter(Context context, ArrayList<CinemaMoidById.ResultBean> list) {
