 ...
 *Description:热门电影 分类
 */
public class Classify_film_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private Context context;
    private List<ReleaseBean.ResultBean> list;

    public Classify_film_Adapter(Context context, ArrayList<ReleaseBean.ResultBean> list) {
