...
public class DetailBean {
    ...
    public static class ResultBean {
        ...
        public ResultBean(String director, String duration, int followMovie, int id, String imageUrl, String movieTypes, String name, String placeOrigin, int rank, String starring, String summary, List<String> posterList, List<ShortFilmListBean> shortFilmList) {
